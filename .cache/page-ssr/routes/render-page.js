...
var _scrollHandler = __webpack_require__(9824);
__webpack_unused_export__ = _scrollHandler.ScrollHandler;
var _useScrollRestoration = __webpack_require__(6306);
...
var _interopRequireDefault = __webpack_require__(5855);
exports.__esModule = true;
exports.ScrollHandler = exports.ScrollContext = void 0;
var _assertThisInitialized2 = _interopRequireDefault(__webpack_require__(9614));
var _inheritsLoose2 = _interopRequireDefault(__webpack_require__(6144));
var React = _interopRequireWildcard(__webpack_require__(2121));
var _propTypes = _interopRequireDefault(__webpack_require__(2736));
var _sessionStorage = __webpack_require__(1178);
...
var _scrollHandler = __webpack_require__(9824);
var _react = __webpack_require__(2121);
var _reachRouter = __webpack_require__(7549);
...
var _react = _interopRequireDefault(__webpack_require__(2121));
var _gatsbyScript = __webpack_require__(6877);
var _getForwards = __webpack_require__(3384);
...
exports.components={"component---src-pages-404-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-404-tsx */ 453).then(__webpack_require__.bind(__webpack_require__, 9763)),"component---src-pages-index-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-index-tsx */ 245).then(__webpack_require__.bind(__webpack_require__, 7511))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-image',plugin:__webpack_require__(6558),options:{"plugins":[]}},{name:'gatsby-plugin-sitemap',plugin:__webpack_require__(2277),options:{"plugins":[],"output":"/","createLinkInHead":true,"entryLimit":45000,"query":"{ site { siteMetadata { siteUrl } } allSitePage { nodes { path } } }","excludes":[]}},{name:'partytown',plugin:__webpack_require__(8053),options:{"plugins":[]}}];/* global plugins */// During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
//   },
// ]
const apis=__webpack_require__(217);function augmentErrorWithPlugin(plugin,err){if(plugin.name!==`default-site-plugin`){// default-site-plugin is user code and will print proper stack trace,
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2121);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/@gatsbyjs+reach-router@2.0.1_react-dom@18.3.1_react@18.3.1/node_modules/@gatsbyjs/reach-router/dist/index.modern.mjs
var index_modern = __webpack_require__(7549);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/react-server-dom-webpack@0.0.0-experimental-c8b778b7f-20220825_react@18.3.1_webpack@5.94.0/node_modules/react-server-dom-webpack/index.js
var react_server_dom_webpack = __webpack_require__(2086);
...
var find_path = __webpack_require__(9469);
...
var public_page_renderer = __webpack_require__(9415);
var public_page_renderer_default = /*#__PURE__*/__webpack_require__.n(public_page_renderer);
// EXTERNAL MODULE: ./node_modules/.pnpm/gatsby-react-router-scroll@6.13.1_@gatsbyjs+reach-router@2.0.1_react-dom@18.3.1_react@18.3.1/node_modules/gatsby-react-router-scroll/index.js
var gatsby_react_router_scroll = __webpack_require__(1946);
// EXTERNAL MODULE: ./node_modules/.pnpm/prop-types@15.8.1/node_modules/prop-types/index.js
var prop_types = __webpack_require__(2736);
var prop_types_default = /*#__PURE__*/__webpack_require__.n(prop_types);
// EXTERNAL MODULE: external "/Users/0-chan/workspace/personal/0-chan.io/node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"
var index_js_ = __webpack_require__(2121);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/gatsby-link@5.13.1_@gatsbyjs+reach-router@2.0.1_react-dom@18.3.1_react@18.3.1/node_modules/gatsby-link/dist/index.modern.mjs
"use client"
...
var context = __webpack_require__(1674);
// EXTERNAL MODULE: ./.cache/slice/server-slice-renderer.js
var server_slice_renderer = __webpack_require__(1541);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/gatsby-script@2.13.0_@gatsbyjs+reach-router@2.0.1_react-dom@18.3.1_react@18.3.1/node_modules/gatsby-script/dist/index.modern.mjs
var dist_index_modern = __webpack_require__(6877);
...
/* harmony export */ });
/* harmony import */ var _api_runner_ssr__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5306);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6070);
const React=__webpack_require__(2121);const{grabMatchParams}=__webpack_require__(9469);const{StaticQueryContext}=__webpack_require__(2840);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(89);const{ServerLocation,Router}=__webpack_require__(7549);const{renderToString}=__webpack_require__(7115);const{parse}=__webpack_require__(877);const styleToOjbect=__webpack_require__(7727);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
...
"use strict";
var React=_interopRequireWildcard(__webpack_require__(2121));var _gatsby=__webpack_require__(2840);var _path=__webpack_require__(2003);function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function _getRequireWildcardCache(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: Remove for v3 - Fix janky path/asset prefixing
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(2460),e=__webpack_require__(2121),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
...
if (true) {
  module.exports = __webpack_require__(6739);
} else {}
 ...
 * LICENSE file in the root directory of this source tree.
 */
var f=__webpack_require__(2121),k=Symbol.for("react.element"),l=Symbol.for("react.fragment"),m=Object.prototype.hasOwnProperty,n=f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p={key:!0,ref:!0,__self:!0,__source:!0};
...
"use strict";
module.exports = require("/Users/0-chan/workspace/personal/0-chan.io/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = require("/Users/0-chan/workspace/personal/0-chan.io/node_modules/.pnpm/react-dom@18.3.1_react@18.3.1/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/Users/0-chan/workspace/personal/0-chan.io/node_modules/.pnpm/react@18.3.1/node_modules/react/index.js");
...
var setPrototypeOf = __webpack_require__(3619);
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2121);
/* harmony import */ var _gatsbyjs_reach_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7549);
"use client"
...
/* harmony import */ var react_server_dom_webpack_writer_node_server__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6808);
const React=__webpack_require__(2121);const path=__webpack_require__(2003);const{renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(7115);const{ServerLocation,Router,isRedirect}=__webpack_require__(7549);const merge=__webpack_require__(7314);const{StaticQueryContext}=__webpack_require__(2840);const fs=__webpack_require__(1546);const{WritableAsPromise}=__webpack_require__(3373);const{RouteAnnouncerProps}=__webpack_require__(6064);const{apiRunner,apiRunnerAsync}=__webpack_require__(5306);const asyncRequires=__webpack_require__(1711);const{version:gatsbyVersion}=__webpack_require__(700);const{grabMatchParams}=__webpack_require__(9469);const{headHandlerForSSR}=__webpack_require__(926);const{SlicesResultsContext,SlicesContext,SlicesMapContext,SlicesPropsContext}=__webpack_require__(1674);const{ServerSliceRenderer}=__webpack_require__(1541);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
const{join}=path.posix;const testRequireError=(moduleName,err)=>{const regex=new RegExp(`Error: Cannot find module\\s.${moduleName}`);const firstLine=err.toString().split(`\n`)[0];return regex.test(firstLine);};let Html;try{Html=__webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../src/html'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));}catch(err){if(testRequireError(`../src/html`,err)){Html=__webpack_require__(8887);}else{throw err;}}Html=Html&&Html.__esModule?Html.default:Html;const getPageDataPath=path=>{const fixedPagePath=path===`/`?`index`:path;return join(`page-data`,fixedPagePath,`page-data.json`);};const createElement=React.createElement;const sanitizeComponents=components=>{const componentsArray=[].concat(components).flat(Infinity).filter(Boolean);return componentsArray.map(component=>{// Ensure manifest is always loaded from content server
