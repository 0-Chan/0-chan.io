...
- - -
References )  
ㄱ. [dotenv-npm](https://www.npmjs.com/package/dotenv)  
ㄴ. [Stackoverflow](https://stackoverflow.com/questions/59243719/setting-up-env-variables-without-create-react-app) dotenv without CRA
